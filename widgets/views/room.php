...
<div style="height:50px; border-radius: 8px 8px 0px 0px; background-color:#1C2025; padding-top:6px; padding-right:12px">
    <div class="pull-right" style="margin-top:2px;margin-right:12px">
        <?php // Html::a(Yii::t('JitsiMeetCloud8x8Module.base', 'Invite'), '#', ['class' => 'btn btn btn-default', 'data-action-click' => 'share', 'data-action-block' => 'sync', 'data-action-url' => Url::to(['/jitsi-meet-cloud-8x8/room/share'])]); ?>
        <?= Html::a(Yii::t('JitsiMeetCloud8x8Module.base', 'Close'), '#', ['class' => 'btn btn btn-default', 'data-ui-loader' => '', 'data-action-click' => 'close', 'data-action-block' => 'manual']); ?>
    </div>
